      ...
      <div className="container mx-auto px-4 text-center">
        <GlassMorphCard>
          ...
          <p className="max-w-3xl mx-auto text-xl mb-12 leading-relaxed text-gray-300">
            At Aqua Essence, we don't just serve water; we curate transcendent
            experiences. Our master hydro-sommeliers craft each elixir to awaken
            your senses and connect you with the primordial essence of life
            itself.
          </p>
          <motion.button
